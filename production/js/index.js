...
// console.log(window.innerHeight, nav.offsetHeight)
  ...
  setInterval(() => {
    video.style.height=`${(window.innerHeight-nav.offsetHeight-footer.offsetHeight)/window.innerHeight*100}%`
  },0.1)
};
...
const dynamicVideoWidth = () => {
  ...
  setInterval(() => {
    ...
    // console.log(tabsLeft,window.innerWidth)
      tabGroup.style.width = `${(window.innerWidth-tabsLeft)/window.innerWidth*100}%`;
...
const dynamicMobileHeight = () => {
  ...
  let video = document.querySelector(".video-group")
  setInterval(() => {
    document.querySelector(".mobile-tabs").style.height=`${(window.innerHeight-nav.clientHeight-footer.clientHeight-video.clientHeight)/window.innerHeight*100}%`
  },0.1)
}
// mobile height
// 載入
